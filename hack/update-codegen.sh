...
generate-groups.sh "deepcopy" \
  github.com/Sean0124/cert-manager/pkg/client github.com/Sean0124/cert-manager/pkg/acme/webhook/apis \
  acme:v1alpha1 \
  --output-base "${GOPATH}/src/" \
  --go-header-file "${runfiles}/hack/boilerplate/boilerplate.go.txt"

generate-groups.sh "deepcopy,client,informer,lister" \
  github.com/Sean0124/cert-manager/pkg/client github.com/Sean0124/cert-manager/pkg/apis \
