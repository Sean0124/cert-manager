...
import (
	...
	"github.com/Sean0124/cert-manager/hack/release/pkg/util"
)
...
func (g *Global) AddFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&g.UpstreamRepoURL, "git.upstream-repo-url", "https://github.com/Sean0124/cert-manager.git", "the URL of the git repo used to check for tags when generating --app-version")
