...
.. code:: shell
   ...
   kubectl apply \
        -f https://github.com/Sean0124/cert-manager/releases/download/<version>/cert-manager.yaml
...
.. _`static deployment manifests`: https://github.com/Sean0124/cert-manager/blob/release-0.9/deploy/manifests
