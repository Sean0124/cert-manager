...
.. code-block:: shell
   ...
   kubectl delete -f https://github.com/Sean0124/cert-manager/releases/download/v0.9.1/cert-manager.yaml

   kubectl apply -f https://github.com/Sean0124/cert-manager/releases/download/v0.9.1/cert-manager-no-webhook.yaml

Once you have re-installed cert-manager, you should then
:doc:`restore your configuration </tasks/backup-restore-crds>`.

.. _`cert-manager.yaml`: https://github.com/Sean0124/cert-manager/releases/download/v0.9.1/cert-manager.yaml
.. _`cert-manager-no-webhook.yaml`: https://github.com/Sean0124/cert-manager/releases/download/v0.9.1/cert-manager-no-webhook.yaml
