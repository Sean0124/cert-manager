...
.. code-block:: shell
   ...
   kubectl apply -f https://github.com/Sean0124/cert-manager/releases/download/v0.9.1/cert-manager.yaml
...
.. _`Helm chart README`: https://github.com/Sean0124/cert-manager/blob/release-0.9/deploy/charts/cert-manager/README.md
